...
if(hours == 24  && minutes == 00 )//вместо -- ставить время 
{
 
    client.users.forEach(cheli => cheli.send("Если понравилось наше сообщество - приглашайте знакомых и друзей,или просто размещайте инфу в соцсетях о сервере. Буду благодарен за помощь. п.с. но вход строго от 20+,ясли и детский сад тут не нужны."))
...
if(message.content.toLowerCase().startsWith("привет"))
{
 ...
 message.channel.send("Здравия желаю!")
}
